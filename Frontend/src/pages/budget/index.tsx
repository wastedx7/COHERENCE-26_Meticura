    ...
    return (
        <div className="flex flex-col gap-6 animate-fade-in pb-12">
            <div className="flex justify-between items-end">
                <div>
                    <h1 className="text-3xl font-bold text-slate-900 tracking-tight">Budget Overview</h1>
                    <p className="text-slate-500 mt-1">Manage departmental allocations and track utilization</p>
                </div>
            ...
            <div className="glass-panel p-6">
                <div className="grid grid-cols-1 md:grid-cols-4 gap-6 divide-y md:divide-y-0 md:divide-x divide-slate-200">
                    <div className="flex flex-col px-4">
                        <span className="text-sm font-medium text-slate-500 mb-1">Total Allocated</span>
                    ...
                    <div className="flex flex-col px-4">
                        <span className="text-sm font-medium text-slate-500 mb-1">Avg Utilization</span>
                    ...
                    <div className="flex justify-around items-center px-4">
                        <div className="text-center">
                            <p className="text-xs text-slate-500 uppercase font-semibold">On Track</p>
                        ...
                        <div className="text-center">
                            <p className="text-xs text-slate-500 uppercase font-semibold">Exceeded</p>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mt-2">
                {isLoading ? (
                        ...
                        <Link to={`/budget/department/${dept.id || i + 1}`} key={dept.id || i} className="glass-card p-6 flex flex-col group relative overflow-hidden">
                            ...
                            <div className="mt-auto relative z-10">
                                <div className="flex justify-between text-sm mb-1">
                                    <span className="text-slate-600 font-medium tracking-tight">Utilization</span>
                                ...
                                <div className="flex justify-between text-xs text-slate-500 mt-2">
                                    <span>Spent: ₹{((dept.spent_amount || Math.random() * 5000000) / 100000).toFixed(1)}L</span>
                                    <span>Alloc: ₹{((dept.allocated_amount || 10000000) / 100000).toFixed(1)}L</span>
                                </div>
                            </div>
                    ...
                    <div className="col-span-full py-12 flex flex-col items-center justify-center text-slate-500 glass-panel">
                        ...
                        <p className="text-lg font-medium">No departments found matching criteria.</p>
                    </div>
                )}
            </div>
        </div>
