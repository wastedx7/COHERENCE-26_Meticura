            ...
            <div className="container mx-auto px-6 lg:px-12">
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
                    ...
                    >
                        ...
                        <div className="flex flex-col sm:flex-row gap-4 mt-4">
                            <CTAButton variant="primary" icon className="py-4 px-8 text-lg" onClick={handleDemoClick}>
                                View Demo
                            </CTAButton>
                ...
                >
                    <div className="bg-white/5 backdrop-blur-sm border border-white/10 rounded-2xl p-6 hover:bg-white/10 transition-all">
                        <div className="text-3xl font-bold text-primary-yellow mb-2">4 Stages</div>
                        <div className="text-white font-semibold mb-1">Complete Pipeline</div>
                        <div className="text-gray-400 text-sm">Track • Detect • Predict • Fix</div>
                    </div>
                    <div className="bg-white/5 backdrop-blur-sm border border-white/10 rounded-2xl p-6 hover:bg-white/10 transition-all">
                        <div className="text-3xl font-bold text-warning-yellow mb-2">Real-Time</div>
                        <div className="text-white font-semibold mb-1">Fraud Anomalies</div>
                        <div className="text-gray-400 text-sm">Detected via Isolation Forest</div>
                    </div>
                    <div className="bg-white/5 backdrop-blur-sm border border-white/10 rounded-2xl p-6 hover:bg-white/10 transition-all">
                        <div className="text-3xl font-bold text-green-400 mb-2">Weekly</div>
                        <div className="text-white font-semibold mb-1">Reallocation Targets</div>
                        <div className="text-gray-400 text-sm">Stop budget from lapsing</div>
                    </div>
                </motion.div>
